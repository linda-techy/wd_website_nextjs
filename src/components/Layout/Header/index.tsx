          ...
          <div className="flex items-center gap-2 sm:gap-6">
            ...
            <div className={`hidden md:block`}>
              <Link
                ...
                className={`text-base md:text-lg font-medium text-inherit flex items-center gap-2 border-r pr-6 ${
                  isHomepage
                    ? sticky
            ...
            <div>
              <button
                ...
                className={`flex items-center gap-3 p-2 sm:px-5 sm:py-3 rounded-full text-base font-semibold hover:cursor-pointer border ${
                  isHomepage
                    ? sticky
              ...
              >
                ...
                <span className="hidden sm:block text-base">Menu</span>
              </button>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col h-full justify-between">
          ...
          <div className="flex flex-col gap-2 my-16 text-white">
            ...
            <Link
              ...
              className="text-base md:text-lg font-medium text-inherit hover:text-primary leading-relaxed"
            >
